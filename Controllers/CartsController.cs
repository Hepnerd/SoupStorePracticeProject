...
namespace SoupStorePracticeProject.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,product,quantity,price,user")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,product,quantity,price,user")] Cart cart)
        {
            if (id != cart.Id)
            {
                return NotFound();
